...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False, res_d=False, stride=2):
        super(ResNet, self).__init__()
        self.res_d = res_d
        self.inplanes = 64
        self.conv1 = nn.Conv2d(3, 64, kernel_size=(7, 7), stride=(stride, stride), padding=(3, 3),
                               bias=False)
